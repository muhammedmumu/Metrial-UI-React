...
export default function Navbar() {
  ...
  const handleThemeToggle = () => {
    actions.toggleTheme();
    console.log('Theme toggled to:', themeState.mode === 'light' ? 'Dark Mode' : 'Light Mode');
  };
    ...
    >
      <Toolbar sx={{ minHeight: layout.navbar.height }}>
        ...
        >
          ...
          >
            <ListItemIcon>
              {themeState.mode === 'dark' ? <LightModeIcon fontSize="small" /> : <DarkModeIcon fontSize="small" />}
            </ListItemIcon>
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
              ...
              <Typography variant="caption" color="text.secondary">
                Switch to {themeState.mode === 'dark' ? 'light' : 'dark'} theme
              </Typography>
            </Box>
          </MenuItem>
